...
(function ($) {
    ...
    function initMap() {
        // Lokasi default (misalnya, pusat Kuala Lumpur)
    ...
    function addMarkers(stores) {
        markers.forEach(marker => marker.setMap(null)); // Hapus marker sebelumnya
    ...
    document.getElementById('searchButton').addEventListener('click', function () {
        ...
        addMarkers(filteredStores); // Tambahkan marker untuk hasil pencarian
    });
