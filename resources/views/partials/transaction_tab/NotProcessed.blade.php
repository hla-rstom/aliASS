...
<div class="tab-pane fade show active" id="NotProcessed" role="tabpanel" aria-labelledby="NotProcessed-tab">
    <div class="row ml-4">
        <div class="col-lg-12">
            <div class="text-left mb-4">
                <button class="btn btn-outline-primary" data-toggle="modal" data-target="#pullOrder"><i class="fas fa-solid fa-arrow-down"></i> Pull Transaction Marketplace</button>
            </div>
            <table class="table">
                ...
                <tbody>
                    @foreach ($shipment_list as $transaction)
                    <tr>
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="pullOrderLabel"> Pull Transaction Marketplace</h5>
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-warning" role="alert">
                    Hi, you don't have a registered store yet! Please add your store in Product -> Marketplace Product.
                </div>
                @else
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="row align-items-center justify-content-around">
                            <div class="col-auto">
                                <a href="{{ route('pullorder',['type' => $item->driver, 'shopid' => $item->shop_id]) }}" class="list-group-item list-group-item-action d-flex align-items-center">
                                    <img src="{{ asset('asset/img/' . $item->driver . '.png') }}" alt="Shopee" width="50">
