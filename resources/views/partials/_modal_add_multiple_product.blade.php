...
<form id="form2" action="{{ route('storerequest') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="modal-body">
                <div class="row mt-2">
                    ...
                    <div class="justify-content-end">
                        <button id="submitModal" type="button" class="btn btn-warning" data-dismiss="modal">Add</button>
                                    ...
                                    <div class="row">
                                        <table class="table">
                                            <thead class="thead-light">
                                                <tr>
                                                    <th><input type="checkbox" id="checkAll" class="large-checkbox mr-2" style="transform: scale(1.5);"> Product</th>
                                                </tr>
                                            </thead>
                                                            ...
                                                            <div class="d-flex align-items-start">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p>SKU: {{ $product->sku ?? '' }} <br>
                                                                        <b class="text-warning">Stock Seller: {{ $product->stock ?? '' }}</b>
                                                                    </p>
...
<script>
    $(document).ready(function() {
        ...
        // Object to hold selected products
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-start">
                                                        ...
                                                        <div>
                                                            <h5 class="card-title d-inline">${product.name}</h5>
                                                            <p>SKU: ${product.sku} <br>
                                                            <b class="text-warning">Stock Seller: ${product.stock || 'N/A'}</b>
                                                            </p>
                                                            <td>${imageHtml}</td>
                                                        </div>
                                                    </div>
        ...
        $('#submitModal').click(function() {
            ...
            $('.checkItem:checked').each(function() {
                ...
                var productName = productDetails.find('.card-title').text();
                var productSKU = productDetails.find('p').text().replace('SKU: ', '');
                var sellerStock = productDetails.find('b.text-warning').text().replace('Stock Seller: ', '') || 1;
                ...
                <tr>
                    ...
                    <td class="qty-input">
                        <button type="button" class="btn btn-outline-warning minus-btn" data-id="${productId}">-</button>
                        ...
                        <button type="button" class="btn btn-outline-warning plus-btn" data-id="${productId}">+</button>
                    </td>
                    <td></td>
                    <td></td>
