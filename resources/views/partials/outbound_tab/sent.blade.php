<div class="tab-pane fade" id="sent" role="tabpanel" aria-labelledby="sent-tab">
    <div class="row ml-4">
        <div class="col-lg-12">
            <p class="mb-3 text-large text-gray-800 ml-3"><b>Sent List</b></p>
            <table class="table">
                ...
                <tbody>
                    @foreach ($transactions4 as $transaction )
                    <tr>
                        ...
                        <td data-toggle="modal" data-target="#shipping{{$transaction->id}}">
